...
% siteLxParser
Como descrito em \cite{siteLxParser}, \textquote{O LX-Parser é um analisador sintáctico de constituência para o Português baseado numa abordagem estatística}. Em \cite{Branco2010OutOfTheBox} podemos ver que tanto o Bosque quanto o CINTIL foram considerados para o seu desenvolvimento. Cabe uma citação: 
\textquote{A maior parte do artigo, na verdade, consiste na descrição das muitas dificuldades que os autores tiveram de lidar quando adaptando o formato de árvore do Bosque para o formato adequado para treinar o \textit{parser}}
