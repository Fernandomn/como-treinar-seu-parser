\begin{figure}[!h]
    ...
    \begin{minipage}{10cm}
        ...
        \ldots
    \end{minipage}
    \caption[Exemplo de marcação de porcentagem pelo Bosque]{Exemplo de marcação de porcentagem pelo Bosque, formato Árvores Deitadas. Adaptado de \citeonline[p~115]{afonso2006arvores}}
